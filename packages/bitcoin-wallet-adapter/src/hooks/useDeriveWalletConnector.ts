 ...
 * You can also implement your own logic to get the derived wallet connector by using the `DeriveWalletConnector` class from `zeus-widget/bitcoin-wallet-adapter`.
 */
